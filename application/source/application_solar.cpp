...
/*   std::cout<<scene_graph_.getRoot().getChild("geo_Earth")->getName()<<std::endl;
...
void ApplicationSolar::initializeOrbits(){
  ...
  for(std::shared_ptr<Node> x : list_of_geoPlanets){
    ...
    std::cout<<planet->getParent()->getParent()->getName()<<std::endl;
